...
export default function MasterSheet() {
    ...
    const handleUpsellTakeRateReport = async () => {
        ...
        const upsellProductIds: upsellProductIdsInterface = tableHead.upsellTakeRateReport.productIds![brandName];
        let campaingsIdsObj= tableHead.upsellTakeRateReport.campaignIds![brandName];
        let campaignids=Object.values(campaingsIdsObj)[0];
        console.log('upsellCampaignIds',campaignids);
...
type tableSheet = {
    ...
    campaignIdsUpsells?:upsellCampaignIdsInterface
}
...
type upsellCampaignIdsInterface = {
        NYMBUS?: {
            lashCosmetics: string;
            browCharm: string;
            floralSecrets: string;
