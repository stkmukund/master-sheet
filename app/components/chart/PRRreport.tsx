...
export default async function PRRreport({ brandName }: { brandName: string }) {
    const projectedBilling: [string[]] = await SheetDataPage(brandName, 'projectedRebillRevenue');
                ...
                revenues.length > 0 && (
                    <div className="container mx-auto">
                        <div className="flex gap-1">
                            <h1 className="font-bold underline">Projected Rebill Revenue</h1>
                            <span>- {brandName}</span>
                        </div>
